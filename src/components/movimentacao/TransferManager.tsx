...
import { TransferRecord } from '../../types/movimentacao';
...
export const TransferManager: React.FC<TransferManagerProps> = ({ currentUser }) => {
  ...
  const handleExecuteTransfer = (e: React.FormEvent) => {
    ...
    setNotification({ 
      type: 'success', 
      message: `Transferência de ${transferType} realizada para o aluno ${selectedEnrollment.studentName}. Aluno inserido no final da lista do novo diário.` 
    });
